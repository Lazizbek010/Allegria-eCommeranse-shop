    ...
    <div class="brands">
            ...
            <div class="american-vintage__info">
                ...
                <div class="american-vintage__info__right">
                    ...
                    <p class="description-text">Продукция также включает немногочисленные аксессуары в виде шарфов,
                        ...
                        кожи». Основная цветовая гамма - это спокойные пастельные расцветки: ореховые, бежевые, желтые,
                        серые и так далее.
        ...
        <section class="deha">
            ...
            <div class="deha__about">
                <div class="deha__about__left">
                    ...
                    <p class="description-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi esse sed
                        totam incidunt! Nisi eveniet soluta sed laudantium perferendis voluptate hic molestias, id eos
                        expedita consequatur doloremque illum, iusto nulla quidem impedit alias voluptatum aliquam, non
                        vitae tenetur voluptatem reiciendis pariatur aspernatur. Quod esse corporis molestiae quis
                        facere quia alias, suscipit velit amet rem omnis sit eius repudiandae ex placeat iste ipsum non
                        cumque, nostrum autem nulla qui quos error. Totam reprehenderit soluta dolore excepturi mollitia
        ...
        <section class="birkenstock">
            <div class="birkenstock__img">
                <div class="birkenstock__img__info">
                ...
                <div class="birkenstock__about__left">
                    ...
                    <div class="birkenstock__about__left__img">
                        ...
                        <div class="birkenstock__about__left__img-shape">
                            <svg xmlns="http://www.w3.org/2000/svg" width="273" height="299" fill="none"><path fill="#CEC6C4" stroke="#CEC6C4" stroke-width=".393" d="M272.018 232.636.432 66.423l.205-.335L272.223 232.3z"/><path stroke="#CEC6C4" d="M102.218 75.8a61.499 61.499 0 0 0-24.01 116.72 61.51 61.51 0 0 0 31.534 6.038 61.502 61.502 0 0 0 51.051-35.156"/></svg>
                        </div>
                    </div>
                </div>
