    ...
    <div class="about-product container">
            ...
            <div class="about-product__info">
                ...
                <div class="about-product__info__setting">
                    ...
                    <div class="selection2">
                        <button class="select-font">Оплата и доставка</button>
                        <button class="select-font">Возврат и обмен</button>
                    </div>
        ...
        <div class="about-product__container">
            <div class="similar-products">
                ...
                <div class="left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="41" fill="none"><path stroke="#254A5A" d="M17 1 1 20.5 17 40"/></svg>
                </div>
                <div class="right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="41" fill="none"><path stroke="#254A5A" d="m1 1 16 19.5L1 40"/></svg>
                </div>
            </div>
        </div>
    </div>
